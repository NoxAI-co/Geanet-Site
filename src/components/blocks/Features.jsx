const features = [
  {
    ...
    description:
      'Desarrollamos soluciones adaptadas específicamente a las necesidades de tu empresa.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Utilizamos las últimas tecnologías para garantizar soluciones eficientes y escalables.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Ofrecemos un conjunto completo de herramientas y servicios diseñados para 
